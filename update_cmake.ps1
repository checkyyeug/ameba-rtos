...
# 构建源文件列表字符串
$sourceList = $sourceFiles | ForEach-Object { "    $_" }
$sourceListStr = $sourceList -join "`n"
...
# 保存到文件
$cmakeContent | Out-File -FilePath "C:\RTL\ameba-rtos\component\ui\lvgl\CMakeLists.txt" -Encoding UTF8
